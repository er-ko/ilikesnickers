<x-public-layout>
	...
	<x-slot name="postClose">
		...
		@else
			<a href="{{ route('post.index') }}" class="py-3 pr-3.5 pl-5 rounded-l-full shadow duration-300 bg-pink-600 text-white hover:bg-pink-700 dark:bg-pink-700 dark:text-white dark:hover:bg-pink-800">
				<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
					<path stroke-linecap="round" stroke-linejoin="round" d="M6 18 18 6M6 6l12 12" />
				</svg>
			</a>
	...
	<div class="mt-12">
		<div class="flex items-end justify-between flex-wrap px-3 mb-3 text-gray-800 dark:text-gray-200">
			<h1 class="font-semibold text-2xl">{{ $post->title_h1 }}</h1>
