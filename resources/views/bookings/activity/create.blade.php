<x-app-layout>
	<x-slot name="meta_title">{{ __('new_booking_activity') }}</x-slot>
	<x-slot name="meta_desc">{{ __('new_booking_activity') }}</x-slot>
	<x-slot name="title">{{ __('new_booking_activity') }}</x-slot>
