<x-app-layout>
    ...
    <x-slot name="meta_title">{{ __('messages.countries') }}</x-slot>
	<x-slot name="meta_desc">{{ __('messages.countries') }}</x-slot>
    <x-slot name="title">{{ __('messages.countries') }}</x-slot>
			...
			<table class="table-auto w-full text-sm">
				<thead>
					<tr class="lowercase bg-gray-100 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 dark:text-gray-400">
						...
						<th class="px-2 pt-4 pb-2 text-center">{{ __('messages.code') }}</th>
						...
						<th class="px-2 pt-4 pb-2">{{ __('messages.delivery') }}</th>
