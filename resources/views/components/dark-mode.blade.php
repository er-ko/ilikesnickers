...
>
	<button class="block rounded-r-full duration-300 py-3 pl-3.5 pr-5 bg-white hover:bg-gray-200 dark:bg-gray-950 dark:hover:bg-gray-900 text-gray-400 dark:text-gray-600 hover:text-gray-500 focus:text-gray-500 dark:hover:text-gray-500 dark:focus:text-gray-500 border border-gray-200 dark:border-gray-800" :class="theme ? 'text-gray-700 dark:text-gray-300' : 'text-gray-400 dark:text-gray-600 hover:text-gray-500 focus:text-gray-500 dark:hover:text-gray-500 dark:focus:text-gray-500'" @click="menu = ! menu">
	...
	<div x-show="menu" class="absolute bottom-12 -left-20 z-10 flex flex-col origin-top-right rounded-md bg-white shadow-xl ring-1 ring-gray-900/5 dark:bg-gray-900" @click="menu = false">
