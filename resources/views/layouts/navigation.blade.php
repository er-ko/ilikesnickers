<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="flex mr-40 xl:mr-0">
                <!-- Navigation Links -->
                <div class="hidden space-x-4 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('language.index')" :active="request()->routeIs(['language.index', 'language.edit'])">
                ...
                <!-- Accountancy Dropdown -->
                <div class="hidden sm:flex sm:items-center sm:ms-6">
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none transition ease-in-out duration-150">
                                <div>{{ __('messages.accountancy') }}</div>
                        ...
                        <x-slot name="content">
                            <x-dropdown-link :href="route('address-book.index')">
                                {{ __('messages.address_book') }}
                            </x-dropdown-link>
                            <x-dropdown-link :href="route('category.index')">
                                {{ __('messages.order_received') }}
                            </x-dropdown-link>
                            <x-dropdown-link :href="route('product-group.index')">
                                {{ __('messages.invoice_issued') }}
                            </x-dropdown-link>
                            <x-dropdown-link :href="route('manufacturer.index')">
                                {{ __('messages.stock') }}
                            </x-dropdown-link>
            ...
            <!-- Hamburger -->
            <div class="mr-10 flex items-center sm:hidden">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('language.index')" :active="request()->routeIs(['language.index', 'language.edit'])">
