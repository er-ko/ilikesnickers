<x-app-layout>
    ...
    <x-slot name="title">{{ __('messages.customers') }}</x-slot>

    <x-slot name="submit">
        <a href="{{ route('customer.create') }}" class="p-2.5 pl-4 duration-300 shadow rounded-l-full bg-teal-600 text-white hover:bg-teal-700">
