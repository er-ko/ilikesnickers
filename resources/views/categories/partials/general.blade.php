<div class="grid gap-0 lg:gap-4 grid-cols-1 lg:grid-cols-3">
	<div class="mb-4 lg:mb-0 py-6 px-2 sm:px-4 space-y-4 shadow-sm sm:rounded-lg bg-white text-gray-900 dark:bg-gray-800 dark:text-gray-100">
		<div>
	...
	<div class="relative col-span-2 pt-3 pb-6 px-2 sm:p-4 shadow-sm sm:rounded-lg bg-white text-gray-900 dark:bg-gray-800 dark:text-gray-100">
