<x-app-layout>
    ...
    <x-slot name="meta_title">{{ __('messages.edit_contact') }}</x-slot>
	<x-slot name="meta_desc">{{ __('messages.edit_contact') }}</x-slot>
    <x-slot name="title">{{ __('messages.edit_contact') }}</x-slot>
