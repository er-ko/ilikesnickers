<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto flex flex-wrap lg:space-x-4 sm:px-6 lg:px-8">
            <div class="w-full lg:max-w-[300px] h-fit mb-6 lg:mb-0 p-6 bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg">
